...
export default function Home() {
  ...
  return (
    <div className="w-full">
      <h1 className="text-center p-10 text-3xl font-bold">Comment System</h1>
      <div className="grid lg:grid-cols-3 md:grid-cols-2 gap-5 grid-cols-1 p-10">
        {posts.map((item) => (
          <div key={item._id} className="shadow-2xl shadow-green-300">
            <div className="w-96  shadow-inner flex flex-col gap-4 p-2">
              ...
              <img src={item.post} alt="post" className="w-96 h-96 object-cover" />
